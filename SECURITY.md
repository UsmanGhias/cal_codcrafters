...
Contact: [security@codcrafters.org](mailto:security@codcrafters.org)

Based on [https://supabase.com/.well-known/security.txt](https://supabase.com/.well-known/security.txt)

At CODCrafters Calendar, we consider the security of our systems a top priority. But no
...
- E-mail your findings to [security@codcrafters.org](mailto:security@codcrafters.org).
