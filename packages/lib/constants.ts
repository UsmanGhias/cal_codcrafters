...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://calendar.codcrafters.org";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "CODCrafters Calendar";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "support@codcrafters.org";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "CODCrafters, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "CODCrafters";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "CODCrafters Calendar";
...
export const LOGO_ICON = "/logo.svg";
...
export const ROADMAP = "https://calendar.codcrafters.org/roadmap";
export const DESKTOP_APP_LINK = "https://calendar.codcrafters.org/download";
export const JOIN_COMMUNITY = "https://github.com/usmanghias/codcrafters-calendar/discussions";
export const POWERED_BY_URL = "https://calendar.codcrafters.org/booking";
export const DOCS_URL = "https://calendar.codcrafters.org/docs";
export const DEVELOPER_DOCS = "https://developer.calendar.codcrafters.org";
...
export const DEFAULT_LIGHT_BRAND_COLOR = "#22c55e"; // lime green
export const DEFAULT_DARK_BRAND_COLOR = "#22c55e"; // lime green
